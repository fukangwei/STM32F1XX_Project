...
#define ENC28J60_RST  PAout(4)  // ENC28J60复位引脚
#define ENC28J60_CS   PCout(4)  // ENC28J60片选引脚
#define ENC28J60_INT  PAin(1)   // ENC28J60中断引脚
...
#define RXSTART_INIT    0x0                 // 接收buffer起始位置
